...
/**
      ...
      * @author Steven Velozo <steven@velozo.com>
      */
getDefaultProviders=()=>{let t={};return t.console=e("./Fable-Log-Logger-Console.js"),t.default=t.console,t},t.exports=getDefaultProviders()},{"./Fable-Log-Logger-Console.js":5}],4:[function(e,t,o){t.exports=[{loggertype:"console",streamtype:"console",level:"trace"}]},{}],5:[function(e,t,o){let r=e("./Fable-Log-BaseLogger.js");t.exports=class extends r{constructor(e,t){super(e),this._ShowTimeStamps=!!e.hasOwnProperty("showtimestamps")&&1==e.showtimestamps,this._FormattedTimeStamps=!!e.hasOwnProperty("formattedtimestamps")&&1==e.formattedtimestamps,this._ContextMessage=e.hasOwnProperty("Context")?`(${e.Context})`:t._Settings.hasOwnProperty("Product")?`(${t._Settings.Product})`:"Unnamed_Log_Context",this._OutputLogLinesToConsole=!e.hasOwnProperty("outputloglinestoconsole")||e.outputloglinestoconsole,this._OutputObjectsToConsole=!e.hasOwnProperty("outputobjectstoconsole")||e.outputobjectstoconsole,this.prefixCache={};for(let e=0;e<=this.levels.length;e++)this.prefixCache[this.levels[e]]=`[${this.levels[e]}] ${this._ContextMessage}: `,this._ShowTimeStamps&&(this.prefixCache[this.levels[e]]=" "+this.prefixCache[this.levels[e]])}write(e,t,o){let r="";this._ShowTimeStamps&&this._FormattedTimeStamps?r=(new Date).toISOString():this._ShowTimeStamps&&(r=+new Date);let s=`${r}${this.prefixCache[e]}${t}`;return this._OutputLogLinesToConsole&&console.log(s),this._OutputObjectsToConsole&&void 0!==o&&console.log(JSON.stringify(o,null,2)),s}}},{"./Fable-Log-BaseLogger.js":1}],6:[function(e,t,o){
/**
